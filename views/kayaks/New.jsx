    ...
    <Layout token={token}>
      ...
      <nav style={styles.nav}>
        <ul style={styles.navUl}>
          ...
          <li style={styles.navLi}>
            <a href={`/users/Index?token=${token}`} style={styles.navLink}>Login</a>
          </li>
        </ul>
      </nav>
      ...
      <div style={styles.mainContent}>
        <div style={styles.container}>
          <h1 style={styles.pageTitle}>Create Kayak Profile</h1>
          
          <form action={`/kayaks?token=${token}`} method="POST" encType="multipart/form-data" style={styles.form}>
            ...
            <div style={styles.fieldContainer}>
              ...
              <textarea 
                name="description" 
                placeholder="Describe your kayak, its features, and condition..."
                required
            ...
            <div style={styles.fieldContainer}>
              ...
              >
                <div style={styles.fileInputText}>Upload a photo of your kayak</div>
