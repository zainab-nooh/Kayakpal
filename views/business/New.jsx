    ...
    <Layout>
      ...
      <div style={styles.mainContent}>
        <div style={styles.container}>
          <h1 style={styles.pageTitle}>Create Business Profile</h1>
          
          <a href={`/business/Index?token=${props.token}`} style={styles.backLink}>
            ← Back to Business Profiles
          </a>
          
          <form action={`/business?token=${props.token}`} method="POST" style={styles.form}>
            ...
            {/* <div style={styles.fieldContainer}>
              ...
              >
                <div style={styles.fileInputText}>Upload a photo of your business</div>
